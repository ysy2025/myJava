...
public class IPv6Info extends IPInfo implements Comparable<IPv6Info> {
    ...
    public IPv6Info(BigInteger start, BigInteger end, String country, String province, String city, String address, String isp, boolean overseas, double lat, double lng) {
