...
public class IPv4Info extends IPInfo implements Comparable<IPv4Info> {
    ...
    public IPv4Info(long startLong, long endLong, String country, String province, String city, String address, String isp, boolean overseas, double lat, double lng) {
